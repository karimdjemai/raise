...
import { Allocation } from '@/shared/model/allocation.model';
...
describe('Service Tests', () => {
  describe('Allocation Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Allocation(0, 0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Allocation', async () => {
        const returnedFromService = Object.assign(
          {
            amount: 1,
            cost: 1
      ...
      it('should not return a list of Allocation', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
