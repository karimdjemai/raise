...
describe('Service Tests', () => {
  describe('Supply Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Supply(0, 0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Supply', async () => {
      ...
      it('should not update a Supply', async () => {
      ...
      it('should return a list of Supply', async () => {
        const returnedFromService = Object.assign(
          {
            amount: 1,
            geometry: 'BBBBBB'
      ...
      it('should not return a list of Supply', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Supply', async () => {
